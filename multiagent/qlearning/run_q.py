...
import copy
import numpy as np
from multiagent.qlearning.grid_env import Env
from multiagent.qlearning.agent import Agent
from multiagent.qlearning.policy import Policy
from multiagent.qlearning.memory import Memory
...
if __name__ == "__main__":
    ...
    for i in range(agent_count):
        agent = Agent(actions=list(range(env.n_actions)), agent_id=i, env=env, options={'distributed': False})
    ...
    for episode in range(TOTAL_EPISODES):
        ...
        while True:
            ...
            env.print_value_all(Policy.Q_TABLE)
